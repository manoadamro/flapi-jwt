[![CircleCI](https://circleci.com/gh/manoadamro/flapi/tree/master.svg?style=svg)](https://circleci.com/gh/manoadamro/flapi-jwt/tree/master)
...
__rules__: one or more rules. see [JWT Rules](#JWT-Rules)
